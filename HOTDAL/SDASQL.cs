...
namespace HOTDAL
{
    public class SDASQL : SqlConnector
    {
        ...
        {
            const string SPName = "SELECT BEG_TIME, END_TIME FROM MA_CLS_TIME WHERE TIME_DAY = @P_DAY";
        ...
        {
            const string SPName = "SELECT * FROM MA_COURSE_DOMN WHERE CRSE_DAY = @P_DAY AND CRSE_TIME = @P_TIME AND CRSE_ACTV = 1";
        ...
        {
            const string SPName = "SELECT * FROM MA_CLASS_DOMN WHERE COURSE_ID = @P_CRSE_ID AND CLASS_DATE = @P_DAY";
        ...
        {
            const string SPName = "SELECT * FROM MA_ART_DOMN WHERE ART_ACTIVE = 1 AND ART_SCHOOL_ID = 1 ORDER BY ART_TITLE";
        ...
        {
            const string SPName = "SELECT * FROM MA_ART_DOMN WHERE ART_ID = @P_ART_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_BELT_DOMN A LEFT OUTER JOIN MA_ART_DOMN B ON A.ART_ID = B.ART_ID WHERE BELT_ACTIVE = 1 AND ART_SCHOOL_ID = 1 ORDER BY B.ART_ID, BELT_LEVEL";
        ...
        {
            const string SPName = "SELECT * FROM MA_BELT_DOMN WHERE BELT_ID = @P_BELT_ID AND BELT_ACTIVE = 1 ORDER BY ART_ID, BELT_LEVEL";
        ...
        {
            const string SPName = "SELECT * FROM MA_BELT_DOMN WHERE BELT_ACTIVE = 1 AND ART_ID = @P_ART_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_TIP_DOMN WHERE TIP_ACTIVE = 1 ORDER BY BELT_ID, TIP_LEVEL";
        ...
        {
            const string SPName = "SELECT * FROM MA_TIP_DOMN WHERE TIP_ACTIVE = 1 AND TIP_ID = @P_TIP_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_TIP_DOMN WHERE BELT_ID = @P_BELT_ID AND TIP_ACTIVE = 1 ORDER BY BELT_ID, TIP_LEVEL";
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_ATTEND WHERE CLASS_ID = @P_CLS_ID AND STDT_ID = @P_STDT_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_ATTEND A LEFT OUTER JOIN MA_CLASS_DOMN B ON A.CLASS_ID = B.CLASS_ID INNER JOIN MA_COURSE_DOMN C ON B.COURSE_ID = C.CRSE_ID "
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_INFO WHERE STDT_ID = @P_STDT_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_INFO WHERE STDT_ACTIVE = 1 ORDER BY STDT_LNAME";
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_ART_XREF A LEFT OUTER JOIN MA_BELT_DOMN B ON A.BELT_ID = B.BELT_ID LEFT OUTER JOIN MA_ART_DOMN C ON A.ART_ID = C.ART_ID LEFT OUTER JOIN MA_TIP_DOMN D ON A.TIP_ID = D.TIP_ID WHERE STDT_ID = @P_STDT_ID AND COMP_DATE = '9999-12-31 00:00:00'";
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_ART_XREF A LEFT OUTER JOIN MA_BELT_DOMN B ON A.BELT_ID = B.BELT_ID LEFT OUTER JOIN MA_ART_DOMN C ON A.ART_ID = C.ART_ID LEFT OUTER JOIN MA_TIP_DOMN D ON A.TIP_ID = D.TIP_ID WHERE A.XREF_ID = @P_XREF_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_ART_XREF A LEFT OUTER JOIN MA_BELT_DOMN B ON A.BELT_ID = B.BELT_ID LEFT OUTER JOIN MA_ART_DOMN C ON A.ART_ID = C.ART_ID LEFT OUTER JOIN MA_TIP_DOMN D ON A.TIP_ID = D.TIP_ID WHERE A.ART_ID = @P_ART_ID AND STDT_ID = @P_STDT_ID AND COMP_DATE = '9999-12-31 00:00:00'";
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_ART_XREF A LEFT OUTER JOIN MA_BELT_DOMN B ON A.BELT_ID = B.BELT_ID " + 
                "LEFT OUTER JOIN MA_ART_DOMN C ON A.ART_ID = C.ART_ID LEFT OUTER JOIN MA_TIP_DOMN D ON A.TIP_ID = D.TIP_ID " + 
        ...
        public DataTable ExecuteGET_STUDENT_ART_PREVIOUS_HISTORY_BY_STUDENT_ID(int studentID)
        {
            const string SPName = "SELECT D.ART_ID, D.ART_TITLE, B.BELT_ID, B.BELT_TITLE, C.TIP_ID, C.TIP_TITLE, A.STDT_WHO, A.STDT_DATE FROM " + 
                "(((MA_STDT_HIST A INNER JOIN MA_BELT_DOMN B ON A.STDT_BELT_ID = B.BELT_ID) INNER JOIN MA_ART_DOMN D ON D.ART_ID = B.ART_ID) " + 
                "INNER JOIN MA_TIP_DOMN C ON A.STDT_TIP_ID = C.TIP_ID) WHERE A.STDT_ID = @P_STDT_ID ORDER BY A.STDT_DATE DESC";
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_NBRS WHERE STDT_ID = @P_STDT_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_STDT_NBRS WHERE NBR_ID = @P_NBR_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_TERM_DOMN WHERE TERM_ACTIVE = 1 ORDER BY BELT_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_TERM_DOMN WHERE TERM_ACTIVE = 1 AND TERM_ID = @P_TERM_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_INST_DOMN WHERE INST_DISP = 1 ORDER BY INST_LNAME";
        ...
        {
            const string SPName = "SELECT * FROM MA_INST_DOMN WHERE INST_ID = @P_INST_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_CLASS_DOMN WHERE CLASS_ID = @P_CLS_ID";
        ...
        {
            const string SPName = "SELECT * FROM MA_COURSE_DOMN WHERE CRSE_ACTV = 1 AND CRSE_RPT = 1 AND CLASS_OR_LESSON = 'C' ORDER BY CRSE_DAY, CRSE_TIME";
        ...
        {
            const string SPName = "SELECT * FROM MA_COURSE_DOMN WHERE CRSE_ID = @P_CRSE_ID AND CRSE_ACTV = 1";
        ...
        {
            const string SPName = "INSERT INTO MA_CLASS_DOMN (COURSE_ID, CLASS_DATE) VALUES (@P_CRSE_ID, @P_DAY)";
        ...
        {
            const string SPName = "INSERT INTO MA_STDT_ATTEND (CLASS_ID, STDT_ID, ATTEND) VALUES (@P_CLS_ID, @P_STDT_ID, 0)";
        ...
        {
            const string SPName = "INSERT INTO MA_STDT_CRSE_XREF (STDT_ID, CRSE_ID, ACTIVE) VALUES (@P_STDT_ID, @P_CRSE_ID, 1)";
        ...
        {
            const string SPName = "INSERT INTO MA_STDT_NBRS (STDT_ID, STDT_RELT, STDT_NUM) VALUES" + 
                "(@P_ID, @P_PHONE, @P_RELT)";
        ...
        {
            const string SPName = "INSERT INTO MA_STDT_ART_XREF (STDT_ID, ART_ID) VALUES (@P_STDT_ID, @P_ART_ID)";
        ...
        {
            const string SPName = "INSERT INTO MA_STDT_ART_XREF (STDT_ID, ART_ID, BELT_ID, TIP_ID, CLASS_COUNT) VALUES (@P_STDT_ID, @P_ART_ID, @P_BELT_ID, @P_TIP_ID, @P_CLS_CNT)";
        ...
        {
            const string SPName = "INSERT INTO MA_TERM_DOMN (TERM_TXT_ENG, TERM_TXT_CHN, BELT_ID, TERM_ACTIVE)" +
        ...
        {
            const string SPName = "INSERT INTO MA_INST_DOMN (INST_FNAME, INST_LNAME, INST_STAT, INST_BIO, INST_DISP) VALUES " +
        ...
        {
            const string SPName = "INSERT INTO MA_ART_DOMN (ART_TITLE, ART_SCHOOL_ID, ART_ACTIVE) VALUES (@P_ART_TITLE, @P_SCHOOL_ID, 1)";
        ...
        {
            const string SPName = "INSERT INTO MA_BELT_DOMN (BELT_TITLE, BELT_LEVEL, ART_ID, CLASS_TIP, CLASS_CNT, BELT_ACTIVE) " +
        ...
        {
            const string SPName = "INSERT INTO MA_TIP_DOMN (TIP_TITLE, TIP_LEVEL, BELT_ID, LAST_TIP, TIP_ACTIVE)" +
        ...
        {
            const string SPName = "INSERT INTO MA_COURSE_DOMN (CRSE_TITLE, CRSE_ART_1, CRSE_ART_2, CRSE_DAY, CRSE_TIME, CRSE_INST, CRSE_RPT, CLASS_OR_LESSON, CRSE_ACTV)" +
        ...
        {
            const string SPName = "UPDATE MA_STDT_ATTEND SET ATTEND = 1 WHERE STDT_ID = @P_STDT_ID AND CLASS_ID = @P_CLS_ID";
        ...
        {
            const string SPName = "UPDATE MA_STDT_ART_XREF SET COMP_DATE = @P_CPLT_DT WHERE XREF_ID = @P_XREF_ID";
        ...
        {
            const string SPName = "UPDATE MA_STDT_ART_XREF SET ART_ID = @P_ART_ID, BELT_ID = @P_BELT_ID, TIP_ID = @P_TIP_ID, CLASS_COUNT = @P_CLS_CNT WHERE XREF_ID = @P_XREF_ID";
        ...
        {
            const string SPName = "UPDATE MA_STDT_NBRS SET STDT_RELT = @P_RELT, STDT_NUM = @P_PHONE WHERE NBR_ID = @P_ID";
        ...
        {
            const string SPName = "UPDATE MA_TERM_DOMN SET TERM_TXT_ENG = @P_ENG_TERM, TERM_TXT_CHN = @P_CHN_TERM, BELT_ID = @P_BELT_ID WHERE TERM_ID = @P_TERM_ID";
        ...
        {
            const string SPName = "UPDATE MA_STDT_INFO SET STDT_PYMT_DT = @P_DATE, STDT_PYMT_PLAN = @P_PLAN WHERE STDT_ID = @P_STDT_ID";
        ...
        {
            const string SPName = "UPDATE MA_INST_DOMN SET INST_FNAME = @P_FIRST_NAME, INST_LNAME = @P_LAST_NAME, INST_STAT = @P_TYPE, INST_BIO = @P_BIO WHERE INST_ID = @P_ID";
        ...
        {
            const string SPName = "UPDATE MA_ART_DOMN SET ART_TITLE = @P_ART_TITLE WHERE ART_ID = @P_ART_ID";
        ...
        {
            const string SPName = "UPDATE MA_BELT_DOMN SET BELT_TITLE = @P_TITLE, BELT_LEVEL = @P_LEVEL, ART_ID = @P_ART_ID, CLASS_TIP = @P_CLS_TIP, CLASS_CNT = @P_CLS_CNT WHERE BELT_ID = @P_BELT_ID";
        ...
        {
            const string SPName = "UPDATE MA_TIP_DOMN SET TIP_TITLE = @P_TITLE, TIP_LEVEL = @P_LEVEL, BELT_ID = @P_BELT_ID, LAST_TIP = @P_LAST_TIP WHERE TIP_ID = @P_TIP_ID";
        ...
        {
            const string SPName = "UPDATE MA_COURSE_DOMN SET CRSE_TITLE = @P_CRSE_TITLE, CRSE_ART_1 = @P_FRST_ART, CRSE_ART_2 = @P_SNCD_ART, CRSE_DAY = @P_CRSE_DAY, CRSE_TIME = @P_CRSE_TIME, CRSE_INST = @P_INST_ID, CRSE_RPT = @P_REPEAT WHERE CRSE_ID = @P_CRSE_ID";
        ...
        {
            const string SPName = "UPDATE MA_STDT_CRSE_XREF SET ACTIVE = 0 WHERE STDT_ID = @P_STDT_ID AND CRSE_ID = @P_CRSE_ID";
        ...
        {
            const string SPName = "UPDATE MA_STDT_INFO SET STDT_ACTIVE = 0 WHERE STDT_ID = @P_STDT_ID";
        ...
        {
            const string SPName = "DELETE FROM MA_STDT_NBRS WHERE NBR_ID = @P_ID";
        ...
        {
            const string SPName = "UPDATE MA_TERM_DOMN SET TERM_ACTIVE = 0 WHERE TERM_ID = @P_TERM_ID";
        ...
        {
            const string SPName = "UPDATE MA_INST_DOMN SET INST_DISP = False WHERE INST_ID = @P_ID";
        ...
        {
            const string SPName = "UPDATE MA_ART_DOMN SET ART_ACTIVE = 0 WHERE ART_ID = @P_ART_ID";
        ...
        {
            const string SPName = "UPDATE MA_BELT_DOMN SET BELT_ACTIVE = 0 WHERE BELT_ID = @P_BELT_ID";
        ...
        {
            const string SPName = "UPDATE MA_TIP_DOMN SET TIP_ACTIVE = 0 WHERE TIP_ID = @P_TIP_ID";
        ...
        {
            const string SPName = "UPDATE MA_COURSE_DOMN SET CRSE_ACTV = 0 WHERE CRSE_ID = @P_CRSE_ID";
    ...
    public class SDAProdSQL : SqlConnector
    {
        ...
        {
            const string SPName = "SELECT TRNS_ID, TRNS_SELL, TRNS_PAID, TRNS_TTL, TRNS_BGHT, TRNS_DATE, TRNS_LOC, TRNS_PYMT, TRNS_TAX, TRNS_VOID, TRNS_OTH FROM MA_TRNS_DOMN WHERE TRNS_BGHT = @P_STDT_ID ORDER BY TRNS_ID DESC";
        ...
        public DataTable ExecuteGET_STUDENT_TRANSACTIONS_BY_TRANSACTION_ID(int transactionID)
        {
            ...
            + "FROM MA_TRNS_DOMN WHERE TRNS_ID = @P_TRNS_ID ORDER BY TRNS_ID";
        ...
        {
            const string SPName = "SELECT XREF_ID, PROD_ID, PROD_QTY, PROD_NME, PROD_PRICE, PROD_TAX FROM MA_TRNS_XREF "
        ...
        {
            const string SPName = "SELECT * FROM MA_PROD_DOMN A INNER JOIN MA_PROD_INV C ON A.PROD_ID = C.PROD_ID WHERE A.PROD_DISP = 1";
        ...
        public DataTable ExecuteGET_ITEM_BY_ITEM_ID(int itemID)
        {
            ...
            + "A.PROD_LOC, A.PROD_ID,PROD_SUB_TYPE,PROD_DISP_ONLINE,PROD_DISP_STORE,PROD_CNT,A.PROD_DISP FROM MA_PROD_DOMN A INNER JOIN MA_PROD_INV C ON A.PROD_ID = C.PROD_ID "
        ...
        {
            const string SPName = "SELECT PROD_NAME,PROD_PRICE,PROD_TYPE,PROD_TAX,PROD_FILE_NAME,PROD_DESC,PROD_SALE_ONLINE,PROD_SALE_STORE,PROD_SALE_PRICE,PROD_CODE,"
            + "A.PROD_LOC, A.PROD_ID,PROD_SUB_TYPE,A.PROD_DISP,PROD_DISP_ONLINE,PROD_DISP_STORE,PROD_CNT FROM MA_PROD_DOMN A INNER JOIN MA_PROD_INV C ON A.PROD_ID = C.PROD_ID "
        ...
        public DataTable ExecuteGET_STUDENT_TRANSACTIONS_BY_DATE(string transactionDate)
        {
            const string SPName = "SELECT TRNS_ID, TRNS_SELL, TRNS_TTL, TRNS_BGHT, TRNS_LOC, TRNS_PYMT, TRNS_TAX, TRNS_VOID, TRNS_DATE, TRNS_OTH, TRNS_PAID " +
                "FROM MA_TRNS_DOMN WHERE TRNS_DATE = @P_DATE ORDER BY TRNS_ID";
        ...
        {
            const string SPName = "SELECT TRNS_ID, TRNS_SELL, TRNS_TTL, TRNS_BGHT, TRNS_LOC, TRNS_PYMT, TRNS_TAX, TRNS_VOID, TRNS_DATE, TRNS_OTH, TRNS_PAID " +
                "FROM MA_TRNS_DOMN WHERE TRNS_DATE = @P_DATE AND TRNS_SELL = @P_EMP_ID ORDER BY TRNS_ID";
        ...
        {
            const string SPName = "UPDATE MA_PROD_INV SET PROD_CNT = @P_PROD_CNT, PROD_INV_TMST = CURRENT_TIMESTAMP WHERE PROD_ID = @P_PROD_ID AND PROD_LOC = 'W'";
        ...
        {
            const string SPName = "UPDATE MA_TRNS_DOMN SET TRNS_SELL = @P_SELLER, TRNS_TTL = @P_TOTAL, TRNS_DATE = @P_DATE, TRNS_PYMT = @P_PYMT, TRNS_VOID = @P_VOID, "
        ...
        {
            const string SPName = "UPDATE MA_PROD_DOMN SET PROD_NAME = @P_NAME,PROD_PRICE = @P_PRICE,PROD_TYPE = @P_TYPE,PROD_SUB_TYPE = @P_SUB_TYPE,PROD_TAX = @P_TAX,PROD_DESC = @P_DESC"
        ...
        {
            const string SPName = "INSERT INTO MA_TRNS_DOMN (TRNS_SELL, TRNS_TTL, TRNS_BGHT, TRNS_LOC, TRNS_PYMT, TRNS_DATE, TRNS_TAX, TRNS_VOID, TRNS_PAID, TRNS_OTH) "
        ...
        {
            const string SPName = "INSERT INTO MA_TRNS_XREF (TRNS_ID, PROD_ID, PROD_QTY, PROD_NME, PROD_PRICE, PROD_TAX) VALUES (@P_TRNS_ID,@P_ITEM_ID,@P_ITEM_QTY,@P_ITEM_NME,@P_ITEM_PRICE,@P_ITEM_TAX)";
        ...
        {
            const string SPName = "UPDATE MA_STDT_INFO SET STDT_NOTE = @P_NOTE WHERE STDT_ID = @P_STDT_ID";
        ...
        {
            const string SPName = "INSERT INTO MA_PROD_DOMN (PROD_NAME,PROD_PRICE,PROD_TYPE,PROD_SUB_TYPE,PROD_TAX,PROD_DESC,PROD_SALE_ONLINE,PROD_SALE_STORE," +
        ...
        {
            const string SPName = "INSERT INTO MA_PROD_INV (PROD_CNT, PROD_INV_TMST, PROD_ID, PROD_LOC, PROD_DISP) VALUES (@P_PROD_CNT, CURRENT_TIMESTAMP, @P_PROD_ID,'W',1)";
        ...
        {
            const string SPName = "DELETE FROM MA_TRNS_XREF WHERE XREF_ID = @P_XREF_ID";
        ...
        {
            const string SPName = "UPDATE MA_PROD_DOMN SET PROD_DISP = 0 WHERE PROD_ID = @P_ID; UPDATE MA_PROD_INV SET PROD_DISP = 0 WHERE PROD_ID = @P_ID;";
