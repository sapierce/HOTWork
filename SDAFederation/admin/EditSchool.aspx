<%@ Page Title="" Language="C#" MasterPageFile="../Federation.Master" AutoEventWireup="true" CodeBehind="EditSchool.aspx.cs" Inherits="SDAFederation.admin.EditSchool" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    ...
    <asp:Button ID="editSchool" runat="server" Text="Edit School" CausesValidation="true" OnClick="editSchool_Click" />
</asp:Content>
