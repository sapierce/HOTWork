<%@ Page Title="" Language="C#" MasterPageFile="../Federation.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="SDAFederation.admin.AddProduct" %>
    ...
    <table class="standardTable">
        ...
        <tr>
            <td class="standardField" colspan="2">
                <asp:Button ID="addProduct" runat="server" Text="Add Item" OnClick="addProduct_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
