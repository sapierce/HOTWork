<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrivacyPolicy.aspx.cs"
    Inherits="PublicWebsite.PrivacyPolicy" MasterPageFile="PublicWebsite.master" %>
...
<asp:Content ID="defaultContent" runat="server" ContentPlaceHolderID="SiteContent">
    ...
    <div style="font-family: arial">
        ...
        your: name, e-mail address, mailing address or phone number. You may, however, visit
        our site anonymously.<br />
        <br />
        ...
        and limitations of liability governing the use of our website at <a href="http://www.hottropicaltans.com/termsofservice.aspx">
            http://www.hottropicaltans.com/termsofservice.aspx</a><br />
        <br />
        <strong>Your Consent</strong>
        <br />
        <br />
        By using our site, you consent to our <a style='text-decoration: none; color: #3C3C3C;'
            href='http://www.freeprivacypolicy.com/' target='_blank'>privacy policy</a>.<br />
        <br />
        ...
        <br />
        <br />
        This policy was last modified on 06/22/2011<br />
        <br />
        ...
        <br />
        <br />
        www.hottropicaltans.com<br />
        710 Valley Mills Drive<br />
        Waco, Texas 76710<br />
        USA<br />
        admin@hottropicaltans.com<br />
        254-399-9944<br />
        <span></span><span></span>
        <center>
            <div style='font-size: 7pt; font-family: Arial; color: gray; text-decoration: none;'>
                Privacy Policy Created by <a style='color: #3C3C3C; text-decoration: none;' href='http://www.freeprivacypolicy.com'
                    target='_blank'>Free Privacy Policy</a>
        </center>
    </div>
    <span></span><span></span><span></span></div><center>
