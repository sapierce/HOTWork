<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TermsOfService.aspx.cs"
    Inherits="PublicWebsite.TermsOfService" MasterPageFile="PublicWebsite.master" %>

<asp:Content ID="defaultContent" runat="server" ContentPlaceHolderID="SiteContent">
    <div>
        <h2>
            Site Terms and Conditions of Use</h2>
        <p>
            <b>1. User's Acknowledgment and Acceptance of Terms</b></p>
        <p>
            ...
            Terms of Use. All such guidelines or rules are hereby incorporated by reference
        ...
        <p>
            ...
            OF USE BECOMES EFFECTIVE IMMEDIATELY UPON COMMENCEMENT OF YOUR USE OF THIS SITE.</p>
        <p>
            These Terms of Use are effective as of 2011-06-22. We expressly reserve the right
            to change these Terms of Use from time to time without notice to you. You acknowledge
            ...
            modified Terms of Use and agreement to abide and be bound by the modified Terms
            of Use.</p>
        <p>
            ...
            involved in creating, producing, and/or delivering this site and/or its contents.</p>
        <p>
            <b>2. Description of Services</b></p>
        <p>
            ...
            and Internet access (including payment of all fees associated with such access).</p>
        <p>
            We reserve the sole right to either modify or discontinue the site, including any
            of the sites features, at any time with or without notice to you. We will not be
        ...
        <p>
            <b>3. Registration Data and Privacy</b></p>
        <p>
            ...
            it current, complete, and accurate.</p>
        <p>
            ...
            Registration Data, is subject to our <u>Privacy Policy</u>, which is specifically
            incorporated by reference into these Terms of Use.</p>
        <p>
            <b>4. Conduct on Site</b></p>
        <p>
        ...
        <p>
            ...
            or otherwise violates our rules or policies;</p>
        <p>
            b. victimizes, harasses, degrades, or intimidates an individual or group of individuals
            on the basis of religion, gender, sexual orientation, race, ethnicity, age, or disability;</p>
        <p>
            c. infringes on any patent, trademark, trade secret, copyright, right of publicity,
            or other proprietary right of any party;</p>
        <p>
            ...
            or any form of lottery or gambling;</p>
        <p>
            ...
            to any data or other information of any third party; or</p>
        <p>
            f. impersonates any person or entity, including any of our employees or representatives.</p>
        <p>
            ...
            with these Terms of Use and any other rules of user conduct for our site, or is
        ...
        <p>
            <b>5. Third Party Sites and Information</b></p>
        <p>
            ...
            or party by us, or any warranty of any kind, either express or implied.</p>
        <p>
            <b>6. Intellectual Property Information</b></p>
        <p>
            Copyright (c) 2011-06-22 HOT Tropical Tans All Rights Reserved.</p>
        <p>
            ...
            boards, chat, and other original content.</p>
        <p>
            By accepting these Terms of Use, you acknowledge and agree that all content presented
            ...
            result in criminal or civil penalties.</p>
        <p>
        ...
        <p>
            ...
            of HOT Tropical Tans or its Affiliates.</p>
        <p>
            <b>7. Unauthorized Use of Materials</b></p>
        <p>
        ...
        <p>
            ...
            ideas or proposals, so please do not submit them to us in any circumstance.</p>
        <p>
        ...
        <p>
            ...
            address is preferred).</p>
        <p>
            4. Provide information, if possible, sufficient to permit us to notify the owner/administrator
            of the allegedly infringing webpage or other content (email address is preferred).</p>
        <p>
        ...
        <p>
            7. Sign the paper.</p>
        <p>
            8. Send the written communication to the following address:</p>
        <p>
            Designated Agent for Claimed Infringement:</p>
        <p>
            Contact: Stephanie Pierce<br />
            Address: 710 North Valley Mills Drive Waco TX 76710<br />
            Phone: 254-399-9944</p>
        <p>
            ...
            Act.</p>
        <p>
            <b>8. Disclaimer of Warranties</b></p>
        <p>
        ...
        <p>
            ...
            TO UPDATE SUCH MATERIALS OR SERVICES.</p>
        <p>
        ...
        <p>
            ...
            SOLELY BY SUCH THIRD PARTY, AND NOT BY US OR ANY OTHER OF OUR AFFILIATES.</p>
        <p>
            ...
            which policies are incorporated by reference into these Terms of Use.</p>
        <p>
            ...
            are completely beyond our control.</p>
        <p>
            ...
            or failure to store any user communications or personalization settings.</p>
        <p>
            SOME STATES OR JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF CERTAIN WARRANTIES, SO
            SOME OF THE ABOVE LIMITATIONS MAY NOT APPLY TO YOU.</p>
        <p>
            <b>9. Limitation of Liability</b></p>
        <p>
            ...
            WITH THE USE OF THIS SITE OR OF ANY WEB SITE REFERENCED OR LINKED TO FROM THIS SITE.</p>
        <p>
            ...
            THIS SITE, INCLUDING WITHOUT LIMITATION THE PROCESSING OF ORDERS.</p>
        <p>
            SOME JURISDICTIONS PROHIBIT THE EXCLUSION OR LIMITATION OF LIABILITY FOR CONSEQUENTIAL
            OR INCIDENTAL DAMAGES, SO THE ABOVE LIMITATIONS MAY NOT APPLY TO YOU.</p>
        <p>
        ...
        <p>
            <b>11. Security and Password</b></p>
        <p>
            ...
            do transfer or share your account.</p>
        <p>
            <b>12. Participation in Promotions</b></p>
        <p>
            ...
            responsibility for any part of any such correspondence or promotion.</p>
        <p>
            <b>13. E-mail, Messaging, Blogging, and Chat Services</b></p>
        <p>
        ...
        <p>
            ...
            that exceed the limit. We will not be responsible for such deleted or blocked messages.</p>
        <p>
            <b>14. International Use</b></p>
        <p>
        ...
        <p>
            ...
            by us in connection with such termination or suspension.</p>
        <p>
            <b>16. Governing Law</b></p>
        <p>
            ...
            jurisdiction within the State of Texas with respect to such matters.</p>
        <p>
            <b>17. Notices</b></p>
        <p>
            ...
            at admin@hottropicaltans.com, if by email, or at HOT Tropical Tans 710 Valley Mills
        ...
        <p>
            ...
            be deemed forever waived and barred.</p>
        <p>
        ...
        <p>
            ...
            purposes any portion of this site, or use of or access to this site.</p>
        <p>
            ...
            to those which are enumerated above.</p>
        <p>
        ...
        <p>
            ...
            related rights shall not constitute a waiver of that right or provision.</p>
        <p>
            <b>20. Contact Information</b></p>
        <p>
            ...
            Terms of Use, please contact us at admin@hottropicaltans.com.</p>
        <h2>
            Terms and Conditions of Sale</h2>
        <p>
            <b>1. Sale and Purchase of Goods</b></p>
        <p>
            ...
            (&quot;Goods&quot;) on the terms and conditions set forth in this Agreement.</p>
        <p>
            <b>2. Purchase Price</b></p>
        <p>
            Buyer agrees to pay the Purchase Price of the Goods as posted on this website attached
            hereto.</p>
        <p>
            <b>3. Payment Terms</b></p>
        <p>
            ...
            including attorney fees, legal fees and costs and disbursements.</p>
        <p>
            <b>4. Delivery</b></p>
        <p>
            ...
            to Seller's standards and practices.</p>
        <p>
            <b>5. Limited Warranty</b></p>
        <p>
            Seller supplies as its sole warranty the following:</p>
        <p>
            No warranties</p>
        <p>
            The warranty shall last for None.</p>
        <p>
            The warranties provided for herein shall be governed by Seller's warranty policies
            in effect on the date of shipment.</p>
        <p>
            <b>6. Disclaimer of Warranty/Limitation of Liability</b></p>
        <p>
            ...
            and conditions, express or implied.</p>
        <p>
        ...
        <p>
            ...
            ACTUALLY DELIVERED TO AND PAID FOR BY BUYER HEREUNDER.</p>
        <p>
            ...
            BY ANY OF THE GOODS.</p>
        <p>
            <b>7. Force Majeure</b></p>
        <p>
        ...
        <p>
            ...
            and venue</p>
        <p>
            Generated by: <a target="_blank" title="Northern Virginia Business Attorneys and Lawyers"
                href="http://www.generalcounsellaw.com">General Counsel, PC</a> and <a target="_blank"
                    title="Small Business Attorneys and Lawyers" href="http://www.LegalRiver.com">Legal
                    River</a>'s <a target="_blank" title="Terms of Service Generator" href="http://tos.legalriver.com">
                        Terms of Service Generator</a></p>
    </div>
</asp:Content>
