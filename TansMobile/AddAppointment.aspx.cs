...
namespace MobileSite
{
    public partial class AddAppointment : System.Web.UI.Page
    {
        ...
        //        string response = sqlClass.ScheduleAppointment(Convert.ToInt32(functionsClass.InternalCleanUp(HttpContext.Current.Session["userID"].ToString())),
        //            functionsClass.InternalCleanUp(ddlPreference.SelectedValue),
        //            functionsClass.FormatDash(Convert.ToDateTime(ddlDate.SelectedValue)),
        //            functionsClass.InternalCleanUp(ddlTimes.SelectedValue), "W", false, chkEmailRemind.Checked);
        ...
        //                    + "<b>Time:</b> " + functionsClass.InternalCleanUp(ddlTimes.SelectedValue) + "<br />"
        //                    + "<b>Bed:</b> " + functionsClass.InternalCleanUp(ddlPreference.SelectedValue) + "<br />";
