<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FullTransactionLog.aspx.cs" Inherits="HOTSelfDefense.Admin.Reports.FullTransactionLog" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
	<head>
		<title>Full Transaction Log for <asp:Literal ID="litDate" runat="server" />
		</title>
	</head>
	<body>
		<form id="frmTrnsFull" method="post" runat="server">
			<p align='center'><asp:label id="lblError" class="error" runat="server" /></p>
			<table width="75%" border="1" bordercolor="#000000">
				<tr>
					<td colspan='7'><h3><asp:Label ID="lblHeader" Runat="server"/></h3>
					</td>
				</tr>
				<tr>
